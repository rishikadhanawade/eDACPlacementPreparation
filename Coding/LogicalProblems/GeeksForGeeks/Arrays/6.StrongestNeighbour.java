...
// Basic Accuracy: 50.02% Submissions: 21130 Points: 1
...
// Your Task:
// The task is to complete the function maximumAdjacent(), which takes sizeOfArray (n) and array(arr) as parameters and prints the maximum of all adjacent pairs 
// (space separated).
